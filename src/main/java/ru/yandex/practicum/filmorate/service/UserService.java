...
public class UserService {
    ...
    public void deleteFriendInMemory(long userId, long friendId) {
        User user = userStorage.getUserById(userId);
        User friend = userStorage.getUserById(friendId);
        if (user != null && friend != null) {
    ...
    public List<User> getAllFriendsInMemory(long userId) {
        User user = userStorage.getUserById(userId);
        List<User> friends = new ArrayList<>();
    ...
    public List<User> getCommonFriendsInMemory(long userId, long otherId) {
        User user = userStorage.getUserById(userId);
